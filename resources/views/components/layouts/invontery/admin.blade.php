...
<head>
    ...
    <style>
        ...
        body[data-theme='dark'] .sidebar .nav-link.dropdown-toggle::after {
            color: #93c5fd !important;
            border-top-color: currentColor;
        }

        body[data-theme='dark'] .sidebar .nav-link.active i,
        body[data-theme='dark'] .sidebar .nav-link.active.dropdown-toggle::after {
            color: #ffffff !important;
        }
        ...
        /* Contrast hardening for both themes */
        body[data-theme='dark'] .admin-info {
            color: #e5e7eb;
        }

        body[data-theme='dark'] .admin-avatar,
        ...
        <div class="sidebar">
            <div class="sidebar-header d-flex justify-content-center">
                <div class="sidebar-title">
                    <img src="{{ asset('images/logo.png') }}" alt="{{ config('shop.name') }}" width="120">
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function refreshThemeNormalization(theme) {
                // Keep theme changes CSS-driven to avoid inline style conflicts.
                return;
            }
