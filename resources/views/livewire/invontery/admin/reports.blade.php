<div>
    ...
    <div class="container-fluid p-0">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="fw-bold mb-1">
                            <i class="bi bi-file-earmark-bar-graph text-success me-2"></i>Reports Dashboard
                        </h4>
        ...
        <div>
            @if($selectedReport === 'daily-sales')
            @include('livewire.invontery.admin.reports.daily-sales-report', ['data' => $currentReportData, 'dailySalesReportTotal' => $currentReportTotal])
            @elseif($selectedReport === 'monthly-sales')
            @include('livewire.invontery.admin.reports.monthly-sales-report', ['data' => $currentReportData, 'monthlySalesReportTotal' => $currentReportTotal])
            @elseif($selectedReport === 'daily-purchases')
            @include('livewire.invontery.admin.reports.daily-purchases', ['reportData' => $currentReportData, 'reportTotal' => $currentReportTotal, 'reportStartDate' => $reportStartDate, 'reportEndDate' => $reportEndDate])
            @elseif($selectedReport === 'inventory-stock')
            @include('livewire.invontery.admin.reports.inventory-stock', ['reportData' => $currentReportData, 'reportStats' => $reportStats ?? []])
            @elseif($selectedReport === 'outstanding-accounts')
            @include('livewire.invontery.admin.reports.outstanding-accounts', ['reportData' => $currentReportData])
            @elseif($selectedReport === 'payments')
            @include('livewire.invontery.admin.reports.payments-report', ['data' => $currentReportData])
            @endif
        </div>
