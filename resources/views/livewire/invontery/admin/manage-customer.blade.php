            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="cursor-pointer" wire:click="goToCustomerTransactions({{ $customer->id }})">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        wire:model="name" placeholder="Enter Business name" required>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control @error('businessName') is-invalid @enderror"
                                        wire:model="businessName" placeholder="Enter Customer Name">
