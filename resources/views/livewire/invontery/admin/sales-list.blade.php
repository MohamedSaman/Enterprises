        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-start border-success border-4 shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs fw-bold text-success text-uppercase mb-1">Net Revenue (after returns)
                            </div>
                    ...
                    <tbody>
                        @forelse($sales as $sale)
                            <tr wire:key="sale-{{ $sale->id }}" style="cursor:pointer" class="table-row"
                                ...
                                <td class="text-center fw-bold" wire:click="viewSale({{ $sale->id }})">
                                    Rs.{{ number_format($sale->total_amount, 2) }}</td>
                                <td class="text-center" wire:click="viewSale({{ $sale->id }})">
                                    <span
                                ...
                                <td class="text-center" wire:click="viewSale({{ $sale->id }})"><span
                                        class="badge bg-warning">{{ strtoupper($sale->sale_type) }}</span></td>
                            ...
                            <div class="col-6 text-end">
                                <table class="table table-sm table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-warning">{{ strtoupper($selectedSale->sale_type) }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <table class="table table-sm table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <strong>Rs.{{ number_format($selectedSale->total_amount, 2) }}</strong></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Due Amount</strong></td>
                                                <td class="text-end">
                                                    <strong>Rs.{{ number_format($selectedSale->due_amount, 2) }}</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="invoice-footer mt-4">
                            ...
                            <div class="border-top pt-3">
                                <p class="text-center mb-0"><strong>ADDRESS :</strong>
                                    {{ config('shop.address', 'NO 92, PASYALA ROAD, KAL-ELIYA, SRI-LANKA.') }}</p>
                                <p class="text-center mb-0"><strong>TEL :</strong>
                                    {{ config('shop.phone', '+94 70 58 53 442') }}, <strong>EMAIL :</strong> {{
                                    config('shop.email', 'phoenixbathware@gmail.com') }}</p>
                        ...
                        @if($selectedSale)
                            <div class="d-flex gap-2">
                                <button type="button" class="btn px-4 py-2"
                                    wire:click="printInvoice({{ $selectedSale->id }})" wire:loading.attr="disabled"
                                    wire:target="printInvoice({{ $selectedSale->id }})"
                        ...
                        @if($selectedSale)
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p><strong>Customer:</strong> {{ $selectedSale->customer->name ?? 'Walk-in Customer' }}
                                    </p>
        ...
        <style>
            ...
            @media print {
                ...
                body {
                    ...
                    Row selection functions function toggleRowHighlight(checkbox) {
