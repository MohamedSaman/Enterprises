                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-4 text-center small">
                            ...
                            <p class="mb-0">
                                ...
                                {{ config('shop.address', 'NO 92, PASYALA ROAD, KAL-ELIYA, SRI-LANKA.') }}<br>
                                <strong>TEL :</strong> {{ config('shop.phone', '+94 70 58 53 442') }}, <strong>EMAIL
                                    :</strong> {{ config('shop.email', 'phoenixbathware@gmail.com') }}
                            </p>
