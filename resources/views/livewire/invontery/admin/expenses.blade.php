<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 flex-wrap gap-3">
        ...
        <div class="d-flex align-items-end gap-2">
            <div>
                <label class="form-label small text-muted mb-0">Filter by Date</label>
                <div class="input-group">
                    <input type="date" class="form-control border-secondary" wire:model.live="filterDate">
                    @if($filterDate)
                    <button class="btn btn-outline-secondary" type="button" wire:click="$set('filterDate', null)" title="Clear Filter">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-4">No monthly expenses found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="saveDailyExpense">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="category" placeholder="Enter type" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="updateExpense">
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Category Type</label>
                            <input type="text" class="form-control" wire:model="edit_category" placeholder="Enter type" required>
...
<style>
    ...
    /* Support for modal labels and other text in dark mode */
