...
class Expenses extends Component
{
    ...
    public function loadExpenses()
    {
        ...
        if ($this->filterDate) {
            $dailyQuery->whereDate('date', $this->filterDate);
            $monthlyQuery->whereDate('date', $this->filterDate);
        }

        $this->dailyExpenses = $dailyQuery->latest()->get();
        $this->monthlyExpenses = $monthlyQuery->latest()->get();
    ...
    {
        return view('livewire.invontery.admin.expenses')->layout($this->layout);
    }
}
