...
class SalesList extends Component
{
    ...
    private function updateProductStock($productId, $quantity)
    {
        ...
        if ($stock) {
            ...
            // Decrease sold_count since units are returned (do NOT increase total_stock)
    ...
    public function getSalesStatsProperty()
    {
        ...
        return [
            ...
            'pending_payments'  => (clone $adminSales)->where('payment_status', 'pending')->sum('due_amount'),
    ...
    {
        return view('livewire.invontery.admin.sales-list', [
            'sales' => $this->sales,
