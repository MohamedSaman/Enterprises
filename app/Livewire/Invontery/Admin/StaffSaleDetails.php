...
#[Layout('components.layouts.invontery.admin')]
class StaffSaleDetails extends Component
{
    ...
    public function printStaffDetails($staffId = null)
    {
        ...
        return view('livewire.invontery.admin.staff-sale-details', compact('staffDetails', 'summaryStats', 'productDetails', 'staffId'));
    }
    ...
    public function render()
    {
        ...
        return view('livewire.invontery.admin.staff-sale-details', [
